...
helicopter_1 = pygame.image.load('sprites/helicopter.png')
...
helicopter_damaged_1 = pygame.image.load('sprites/helicopter_damaged.png')
helicopter_damaged_2 = pygame.image.load('sprites/helicopter_damaged1.png')

enemy_helicopter_1 = pygame.image.load('sprites/enemy_helicopter.png')
enemy_helicopter_2 = pygame.image.load('sprites/enemy_helicopter1.png')
